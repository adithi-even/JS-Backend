...
export const updateUserAvatar = asyncHandler(async(req, res) => {
    ...
    const avatar = uploadOnCloudinary(avatarLocalPath)//here we are gettimg whole objext from the cloudinary 
    
    if (!avatar.url) {
        throw new ApiError(400, "Error while uploading and avatar")
    }
...
export const updateUserCoverImage = asyncHandler(async(req, res) => {
    ...
    const coverImage = uploadOnCloudinary(coverImageLocalPath)//here we are gettimg whole objext from the cloudinary 
